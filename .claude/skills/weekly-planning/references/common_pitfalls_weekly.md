...
### 2. Forgetting to Populate Workout Prescriptions
...
### 11. Missing Required Workout Fields

**Problem**: Incomplete WorkoutPrescription objects (missing pace ranges, purpose, etc.).

**Solution**: Use COMPLETE_WORKOUT_EXAMPLE.json as template. Required fields:
- Identity: id, week_number, day_of_week, date
- Type: workout_type, phase
- Duration: duration_minutes, distance_km
- Intensity: intensity_zone, target_rpe, pace_range_min_km, pace_range_max_km, hr_range_low, hr_range_high
